      ...
      >
        ...
        <el-table :data="newtableData" style="width: 100%">
          ...
          <el-table-column label="备注" align="center">
            <el-table-column label="现有生产能力（吨/年）" align="center">
              <template slot-scope="scope">
                <el-input v-model="scope.row.value"></el-input>
                <!-- <span v-else>{{scope.row.date}}</span> -->
              </template>
            </el-table-column>
            <el-table-column label="上年度产量（吨/年）" align="center">
              <template slot-scope="scope">
                <el-input v-model="scope.row.value"></el-input>
                <!-- <span v-else>{{scope.row.name}}</span> -->
              </template>
        ...
        <el-table :data="tableData">
          <el-table-column label="资料名称" align="center" prop="valuue">
          </el-table-column>
        ...
        <el-form :model="Form" :rules="rules" ref="Form" class="demo-ruleForm">
          <el-form-item label="受理决定" prop="name">
            <el-select v-model="ruleForm.name" placeholder="请选择活动区域">
              <el-option label="区域一" value="shanghai"></el-option>
              <el-option label="区域二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="下一审查人" prop="name">
            <el-select v-model="ruleForm.name" placeholder="请选择活动区域">
              <el-option label="区域一" value="shanghai"></el-option>
              <el-option label="区域二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="受理意见" prop="desc">
            <el-input type="textarea" v-model="ruleForm.desc"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button type="primary">提交</el-button>
            <el-button type="primary">受理通知书</el-button>
            <el-button type="primary">不受理通知书</el-button>
            <el-button type="primary">材料补正告知书</el-button>
          </el-form-item>
        </el-form>
      </el-form>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: '请输入受理决定', trigger: 'blur' },
