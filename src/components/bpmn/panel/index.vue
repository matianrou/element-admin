  ...
  export default {
    ...
    methods: {
      ...
      modifyFormData(data){
        ...
        this.formData.candidateUsers = data.candidateUsers ? data.candidateUsers.split(",") : [];
      }
    },
    components: {
